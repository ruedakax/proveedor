    ...
    <div class="c-form">
        <div>
            <fieldset>
                ...
                <input id="i8_p1_nombre" class="c-form-input i8_p1" type="text" name="i8_p1_nombre" placeholder="Nombre completo" style="max-width:25.296875%;" value="<?php echo $datos['i8_p1_nombre']?>" readonly><span class="c-form-required"> *</span>
                <label class="alt_label c-form-label">&nbsp; representante legal de la empresa</label>
                <input id="i8_p2_empresa" class="c-form-input i8_p2" type="text" name="i8_p2_empresa" placeholder="Empresa" style="max-width:25.296875%;" value="<?php echo $datos['i8_p2_empresa']?>" readonly><span class="c-form-required"> *</span><br/><br/>
                <label class="alt_label c-form-label">con NIT : &nbsp;</label>
                <input id="i8_p3_nit" class="c-form-input i8_p3" type="text" name="i8_p3_nit" placeholder="NIT" style="max-width:22.296875%;" value="<?php echo $datos['i8_p3_nit']?>" readonly><span class="c-form-required"> *</span>
