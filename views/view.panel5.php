            ...
            <div class="c-form">
              <div>
                <fieldset>
                  ...
                  <label class="alt_label c-form-label"><input type="radio" name="i5_p1_check" id="i5_p1_check" value="SI" <?php echo @$datos['i5_p1_check']=="SI"?'checked':''?>>SI</label>
                  <label class="alt_label c-form-label"><input type="radio" name="i5_p1_check" id="i5_p1_check" value="NO" <?php echo @$datos['i5_p1_check']=="NO"?'checked':''?>>NO</label><br/>                  
                </fieldset>
              </div>
              <div id="ley1778">
                <fieldset>
                  ...
                  <label class="alt_label c-form-label"><input type="radio" name="i5_p2_check" id="i5_p2_check" value="SI" <?php echo @$datos['i5_p2_check']=="SI"?'checked':''?>>SI</label>
                  <label class="alt_label c-form-label"><input type="radio" name="i5_p2_check" id="i5_p2_check" value="NO" <?php echo @$datos['i5_p2_check']=="NO"?'checked':''?>>NO</label><br/>
                </fieldset>              
                <fieldset>
                ...
                <fieldset>
                  <input id="i5_p4_fuentes" class="c-form-input i5_p4" type="text" name="i5_p4_fuentes" placeholder="Escriba las fuentes" value="<?=@$datos['i5_p4_fuentes']?>"><span class="c-form-required"> *</span>
                </fieldset>
              </div>              
              <div id="accionistas">
                <fieldset>
