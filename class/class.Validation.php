    ...
    class Validation {
        ...
        public function min($length){
            ...
            if(is_string($this->value)){
                ...
                if(strlen($this->value) < $length){
                    $this->errors[] = array($this->name,'Valore campo '.$this->name.' inferiore al valore minimo');
                }
        ...
        public function max($length){
            ...
            if(is_string($this->value)){
                ...
                if(strlen($this->value) > $length){
                    $this->errors[] = array($this->name,'Valore campo '.$this->name.' superiore al valore maximo');
                }
        ...
        public function equal($value){
            ...
            if($this->value != $value){
                $this->errors[] = $this->errors[] = array($this->name,'Valore campo '.$this->name.' no corresponde');
            }
            return $this;
        ...
        public function maxSize($size){
            ...
            if($this->file['error'] != 4 && $this->file['size'] > $size){
                $this->errors[] = array($this->name,'Il file '.$this->name.' supera la dimensione massima di '.number_format($size / 1048576, 2).' MB.');
            }
            return $this;
        ...
        public function ext($extension){
            ...
            if($this->file['error'] != 4 && pathinfo($this->file['name'], PATHINFO_EXTENSION) != $extension && strtoupper(pathinfo($this->file['name'], PATHINFO_EXTENSION)) != $extension){
                $this->errors[] = array($this->name,'Il file '.$this->name.' non è un '.$extension.'.');
            }
            return $this;
